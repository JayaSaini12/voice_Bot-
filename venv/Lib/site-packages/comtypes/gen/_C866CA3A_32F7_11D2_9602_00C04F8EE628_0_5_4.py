...
__all__ = [
    'DISPID_SPRsCount', 'SVP_7', 'SPGRAMMARSTATE', 'SECFIgnoreCase',
    'IInternetSecurityMgrSite', 'SVPOver', 'DISPID_SWFESamplesPerSec',
    'eLEXTYPE_APP', 'SPAO_NONE', 'DISPID_SRGSetTextSelection',
    'SPEI_MAX_TTS', 'SRSInactive', 'ISpeechLexiconWords',
    'DISPID_SPPsCount', 'SpeechGrammarWordType',
    'DISPID_SDKGetlongValue', 'SP_VISEME_15', 'SPEI_WORD_BOUNDARY',
    'ISpeechLexiconPronunciation', 'ISpeechResourceLoader',
    'DISPID_SpeechRecoContextEvents', 'eLEXTYPE_PRIVATE18',
    'DISPIDSPTSI', 'SECHighConfidence', 'DISPID_SRGDictationUnload',
    'SAFTADPCM_8kHzStereo', 'SPEI_SOUND_END', 'SRAORetainAudio',
    'ISpeechPhraseRule', 'SPPARTOFSPEECH', 'DISPID_SLWType',
    'DISPID_SGRSTsCount', 'SpeechTokenValueCLSID', 'SPEI_ADAPTATION',
    'DISPID_SVGetAudioOutputs', 'SPBINARYGRAMMAR',
    'eLEXTYPE_MORPHOLOGY', 'SRTReSent', 'DISPID_SGRSTType',
    'SREStateChange', 'DISPID_SGRsCommit', 'SpeechVoicePriority',
    'ISpeechXMLRecoResult', 'DISPID_SVSpeakStream',
    'DISPID_SDKCreateKey', 'SPAR_High', 'ISpStreamFormat',
    'DISPID_SRRDiscardResultInfo', 'ISpeechRecoResultDispatch',
    'SpSharedRecognizer', 'SGRSTTDictation',
    'DISPID_SRGetRecognizers', 'SpeechStreamFileMode',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SVResume',
    'ISpeechObjectToken', 'Speech_StreamPos_Asap',
    'SAFTADPCM_8kHzMono', 'SPWORDLIST',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SVEAudioLevel', 'STSF_LocalAppData', 'SpCustomStream',
    'DISPID_SRCEStartStream', 'DISPID_SLGetWords',
    'ISpGrammarBuilder', 'SpeechDataKeyLocation',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SOTDataKey', 'SP_VISEME_5',
    'DISPID_SpeechRecoContext', 'DISPID_SRRSaveToMemory',
    'SDTProperty', 'DISPID_SGRName', 'DISPID_SGRSTsItem',
    'SpeechRecoContextState', 'SPINTERFERENCE_NOSIGNAL',
    'SPCS_ENABLED', '_SPAUDIOSTATE', 'eLEXTYPE_RESERVED4',
    'ISpeechVoiceStatus', 'SpeechRecoEvents',
    'SpeechPropertyResponseSpeed', 'ISpSerializeState',
    'SPPS_Unknown', 'SpUnCompressedLexicon', 'SAFT32kHz16BitMono',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SOTsItem',
    'SDA_One_Trailing_Space', 'ISpeechRecoContext',
    'DISPID_SVDisplayUI', 'ISpRecoCategory', 'SVP_20',
    'SPSERIALIZEDRESULT', 'SPAUDIOSTATUS', 'ISpStreamFormatConverter',
    'SPAS_STOP', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SVSInputSentenceLength', 'DISPID_SOTDisplayUI',
    'DISPID_SVVolume', 'DISPID_SLPsCount', 'ISpNotifySink',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SpInProcRecoContext',
    'SREAdaptation', 'DISPID_SPEs_NewEnum', 'DISPID_SPIReplacements',
    'SPWF_SRENGINE', 'SLODynamic', 'SRATopLevel', 'DISPID_SRStatus',
    'ISpeechPhraseAlternate', 'DISPID_SRCEPropertyStringChange',
    'SpTextSelectionInformation', 'DISPID_SRCEAudioLevel',
    'SPEI_RECO_STATE_CHANGE', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SP_VISEME_17', 'SVEPrivate', 'DISPID_SLPs_NewEnum',
    'eLEXTYPE_RESERVED10', 'DISPID_SRRGetXMLResult',
    'DISPID_SRRTTickCount', 'SECFNoSpecialChars', 'DISPID_SGRsAdd',
    'ISpeechPhraseElements', 'SPFM_OPEN_READWRITE',
    'DISPID_SRCRequestedUIType', 'eLEXTYPE_PRIVATE5',
    'DISPID_SpeechObjectToken', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SRProfile', 'DISPID_SVSPhonemeId', 'SWTDeleted',
    'ISpeechRecognizer', 'SPAO_RETAIN_AUDIO', 'SLTApp', 'SVPAlert',
    'SPRECOCONTEXTSTATUS', 'SPEI_PHRASE_START',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SVP_6',
    'DISPID_SPPName', 'SITooLoud', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SWFEFormatTag', 'SPWT_PRONUNCIATION',
    'SPEI_FALSE_RECOGNITION', 'SAFTExtendedAudioFormat',
    'SAFT16kHz16BitStereo', 'DISPID_SPERetainedSizeBytes',
    'ISpeechFileStream', 'SP_VISEME_16', 'DISPID_SADefaultFormat',
    'SPWT_DISPLAY', 'DISPID_SGRSAddWordTransition',
    'DISPID_SpeechPhraseReplacements',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SPRDisplayAttributes',
    'ISpeechGrammarRules', 'SVP_15', 'SP_VISEME_14',
    'ISequentialStream', 'eLEXTYPE_PRIVATE7', 'SpMMAudioOut',
    'IEnumString', 'SAFT16kHz8BitMono', 'SpeechRegistryUserRoot',
    'SPSHT_NotOverriden', 'DISPID_SGRInitialState', 'SVSFNLPMask',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'tagSPTEXTSELECTIONINFO', 'SSFMOpenForRead',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPAUDIOSTATE',
    'SVSFParseAutodetect', 'SPWORDPRONOUNCEABLE', 'STSF_AppData',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SVEStreamEnd',
    'SPADAPTATIONRELEVANCE', 'SpResourceManager',
    'eLEXTYPE_PRIVATE13', 'STCInprocServer', 'SDTDisplayText',
    'SREAudioLevel', 'ISpeechPhraseRules', 'SAFT22kHz16BitStereo',
    'SAFT32kHz16BitStereo', 'SPEI_SR_AUDIO_LEVEL',
    'eLEXTYPE_PRIVATE8', 'DISPID_SpeechPhraseAlternates',
    'SP_VISEME_3', 'DISPID_SLPsItem', 'DISPID_SpeechPhraseAlternate',
    'SPAS_PAUSE', 'SpeechRunState', 'SVSFIsFilename',
    'DISPID_SLWWord', 'SAFTTrueSpeech_8kHz1BitMono',
    'SAFT12kHz8BitMono', 'UINT_PTR', 'DISPID_SpeechPhraseElement',
    'DISPID_SABIBufferSize', 'SAFT44kHz8BitStereo',
    'DISPID_SVESentenceBoundary', 'DISPID_SpeechVoiceEvent',
    'DISPID_SRCResume', 'SPGRAMMARWORDTYPE', 'SVSFUnusedFlags',
    'DISPID_SBSSeek', 'DISPID_SASState', 'SpMMAudioIn',
    '_ISpeechVoiceEvents', 'DISPID_SASCurrentDevicePosition',
    'SREStreamEnd', 'SpeechGrammarTagDictation',
    'DISPID_SRGDictationLoad', 'DISPID_SVSRunningState',
    'SPDKL_DefaultLocation', 'SpeechPropertyAdaptationOn',
    'DISPID_SRRRecoContext', 'SVSFVoiceMask', 'DISPID_SPACommit',
    'SWPUnknownWordPronounceable', 'SpeechEngineConfidence',
    'SASClosed', 'DISPID_SRCEPropertyNumberChange',
    'SpeechAudioFormatGUIDWave', 'eLEXTYPE_PRIVATE1', 'SREAllEvents',
    'SPRECOGNIZERSTATUS', 'SVEStartInputStream',
    'SpeechRecognizerState', 'eLEXTYPE_PRIVATE6',
    'SAFTCCITT_uLaw_22kHzStereo', 'SITooQuiet', 'SPSNotOverriden',
    'SRERequestUI', 'DISPID_SPIRule', 'DISPID_SGRs_NewEnum',
    'SPWORDPRONUNCIATION', '__MIDL_IWinTypes_0009',
    'DISPID_SPAsCount', 'SSFMOpenReadWrite', 'DISPID_SVSLastResult',
    'DISPID_SRCEInterference', 'SPEVENTENUM', 'ISpeechAudioFormat',
    'SpeechMicTraining', 'DISPID_SpeechLexiconWords', 'DISPID_SOTId',
    'DISPID_SRAudioInput', 'SPEI_SENTENCE_BOUNDARY',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SPRuleId', 'SRERecognition',
    'Speech_Default_Weight', 'SPWORD', 'ISpRecoContext2',
    'SpeechVoiceEvents', 'DISPID_SGRAddResource',
    'DISPID_SVSInputWordLength', 'SPRST_NUM_STATES',
    'DISPID_SASetState', 'SPPHRASEPROPERTY',
    'DISPID_SRGetPropertyNumber', 'Speech_Max_Pron_Length',
    'SASPause', 'SVSFParseMask', 'DISPID_SLPSymbolic',
    'SpPhoneticAlphabetConverter', 'SPVPRI_ALERT', 'SVP_13', 'SPSLMA',
    'DISPID_SPPId', 'DISPID_SRGCmdSetRuleState',
    'Speech_StreamPos_RealTime', 'eLEXTYPE_USER',
    'SAFT11kHz16BitMono', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SGRSTNextState', 'SRAInterpreter', 'SP_VISEME_18',
    'SpObjectTokenCategory', 'SBOPause', 'SAFTNonStandardFormat',
    'DISPID_SRCVoicePurgeEvent', 'ISpEventSource', 'SPEI_RECOGNITION',
    ...
    'IStream', 'SPPS_RESERVED2', 'DISPID_SGRsFindRule',
    'ISpeechPhraseInfoBuilder', 'SGDSActive', 'SPCT_COMMAND',
    'SPPS_RESERVED4', 'DISPID_SPRulesCount', 'ISpeechAudioStatus',
    'SVP_2', 'ISpeechLexiconPronunciations',
    'DISPID_SGRSTPropertyValue', 'DISPID_SPRsItem',
    'SpeechAudioProperties', 'SAFT22kHz16BitMono',
    'DISPID_SPPEngineConfidence', 'SP_VISEME_1',
    'DISPID_SpeechRecoResult2', 'SSFMCreate',
    'DISPID_SRCreateRecoContext', 'SPSHORTCUTPAIRLIST',
    'SREPhraseStart', 'DISPID_SpeechFileStream',
    'DISPID_SRSCurrentStreamNumber', 'SpeechTokenShellFolder',
    'SpeechTokenContext', 'SpeechVoiceSpeakFlags', 'SGSExclusive',
    'DISPIDSPRG', 'DISPID_SPEAudioTimeOffset', 'SAFT12kHz8BitStereo',
    'DISPID_SPRuleFirstElement', 'SPSModifier',
    'DISPID_SABufferNotifySize', 'SP_VISEME_12', 'DISPID_SOTCDefault',
    'SAFTCCITT_ALaw_11kHzStereo', 'SPRECOSTATE', 'SP_VISEME_4',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SpeechPhraseRule',
    'DISPID_SABIMinNotification', 'DISPID_SWFEBlockAlign',
    'SpeechRuleState', 'DISPID_SRGRecoContext',
    'DISPID_SGRSTs_NewEnum', 'ISpeechPhraseAlternates',
    'DISPID_SPPBRestorePhraseFromMemory', 'eLEXTYPE_RESERVED8',
    'SFTInput', 'SPRS_INACTIVE', 'SPEI_PROPERTY_STRING_CHANGE',
    'SAFT24kHz16BitMono', 'SPEI_END_INPUT_STREAM', 'DISPID_SRState',
    'SPDKL_LocalMachine', 'SRAExport', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SREPropertyStringChange', 'SpVoice', 'SAFTCCITT_uLaw_44kHzMono',
    'SPPS_Noncontent', 'DISPID_SRCAudioInInterferenceStatus',
    'SPPS_Function', 'DISPID_SpeechRecoResultTimes',
    'SDTPronunciation', 'ISpeechPhraseInfo', 'SpMemoryStream',
    'SAFT48kHz16BitMono', 'SFTSREngine', 'SP_VISEME_2',
    'DISPID_SPIAudioStreamPosition', 'SPFM_NUM_MODES',
    'DISPID_SPRuleParent', 'ISpLexicon', 'SPLOADOPTIONS', 'ISpAudio',
    'SAFTADPCM_44kHzStereo', 'SpeechGrammarState',
    'SWPKnownWordPronounceable', 'SPINTERFERENCE',
    'SpeechCategoryAudioIn', 'DISPID_SPPsItem', 'DISPID_SPIGrammarId',
    'DISPID_SpeechPhraseInfo', 'DISPID_SpeechPhraseReplacement',
    'SDKLCurrentUser', 'DISPID_SpeechGrammarRules',
    'SAFT44kHz8BitMono', 'SPSTREAMFORMATTYPE', 'SPCT_SUB_COMMAND',
    'DISPID_SPEDisplayText', 'SpeechCategoryVoices',
    'SAFT44kHz16BitMono', 'DISPID_SOTsCount',
    'DISPID_SPEDisplayAttributes', 'DISPID_SPRuleConfidence',
    'SpeechPartOfSpeech', 'DISPID_SDKDeleteKey',
    'DISPID_SRSetPropertyString', 'SP_VISEME_6', 'STSF_CommonAppData',
    'ISpResourceManager', 'SPPS_LMA', 'DISPID_SLPLangId',
    'DISPID_SPAStartElementInResult', 'SpeechAudioFormatType',
    'DISPID_SMSAMMHandle', 'tagSTATSTG', 'SRTEmulated',
    'SPEI_TTS_PRIVATE', 'DISPID_SRCSetAdaptationData',
    'DISPID_SGRSTPropertyName', 'SpeechAudioState',
    'SGDSActiveWithAutoPause',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SDKDeleteValue',
    'SRAONone', 'DISPID_SVAlertBoundary', 'SPSUnknown',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPSHORTCUTPAIR',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SpeechWaveFormatEx',
    'ISpProperties', 'SpeechPropertyLowConfidenceThreshold',
    'SPAR_Medium', 'SVEWordBoundary', 'eLEXTYPE_PRIVATE15',
    'DISPID_SLGenerationId', 'DISPID_SPRulesItem', 'SPSNoun',
    'ISpeechPhoneConverter', 'SAFT22kHz8BitStereo',
    'SpeechVoiceCategoryTTSRate',
    'SpeechPropertyHighConfidenceThreshold',
    'SpeechStreamSeekPositionType', 'SDA_Consume_Leading_Spaces',
    'DISPID_SCSBaseStream', 'SPEI_INTERFERENCE',
    'DISPID_SPRFirstElement', 'SP_VISEME_19', 'SVP_16',
    'DISPID_SRRSpeakAudio', 'ISpeechPhraseElement',
    'SAFT8kHz8BitStereo', 'DISPID_SVSInputWordPosition',
    'STCInprocHandler', 'DISPID_SOTRemove', 'SPEI_MIN_SR',
    'SPLO_STATIC', 'ISpeechRecoResultTimes', 'ISpeechAudio',
    'SPFM_CREATE_ALWAYS', 'SVEViseme', 'DISPID_SPEsItem', 'SRAImport',
    'SDKLCurrentConfig', 'SVF_None', 'SAFT8kHz8BitMono',
    'DISPID_SMSADeviceId', 'SECNormalConfidence', 'SPAS_CLOSED',
    'SPAUDIOBUFFERINFO', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SDKOpenKey', 'DISPID_SRCERequestUI', 'SPVPRI_NORMAL',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SVEventInterests',
    'SGRSTTWord', 'SAFT32kHz8BitMono', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SVSLastStreamNumberQueued', 'SVEVoiceChange',
    'DISPID_SPRules_NewEnum', 'SPRST_INACTIVE', 'SPGS_ENABLED',
    'SGSDisabled', 'DISPID_SPERetainedStreamOffset',
    'SpeechRetainedAudioOptions', 'DISPID_SVGetProfiles',
    'SPBOOKMARKOPTIONS', 'SPEI_UNDEFINED', 'DISPID_SRCState',
    'DISPID_SRIsUISupported', 'DISPID_SRCBookmark',
    'DISPID_SpeechVoice', 'DISPID_SAEventHandle', 'SP_VISEME_7',
    'DISPID_SRCEPhraseStart', 'SP_VISEME_10', 'ISpeechLexiconWord',
    'eLEXTYPE_PRIVATE2', 'SPPS_Modifier', 'DISPID_SPIElements',
    'DISPID_SpeechXMLRecoResult', 'SRSActive', 'SpStream',
    'DISPID_SDKGetBinaryValue', 'SVSFPersistXML', 'DISPID_SOTCSetId',
    'eLEXTYPE_PRIVATE10', 'eLEXTYPE_LETTERTOSOUND',
    'ISpPhoneConverter', 'SRESoundEnd', 'DISPID_SVPause',
    'SAFT48kHz8BitMono', 'SAFTADPCM_22kHzMono', 'ISpeechMemoryStream',
    'SpNotifyTranslator', 'SITooSlow', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SVSpeakCompleteEvent', 'SASStop', 'DISPID_SRCVoice',
    'SpeechUserTraining', 'SGRSTTEpsilon', 'SPBO_PAUSE',
    'DISPID_SRGCmdSetRuleIdState', 'SVP_9', 'ISpeechRecognizerStatus',
    'SpeechRuleAttributes', 'DISPID_SRCERecognition',
    'DISPID_SRCESoundEnd', 'SAFT32kHz8BitStereo',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SPERequiredConfidence', 'SVSFPurgeBeforeSpeak',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SRSetPropertyNumber',
    'SGDSInactive', 'ISpeechGrammarRuleState',
    'DISPID_SVSLastBookmarkId', 'ISpMMSysAudio',
    'SREFalseRecognition', 'DISPID_SBSFormat', 'DISPID_SABufferInfo',
    'DISPID_SVSCurrentStreamNumber', 'SpeechGrammarTagWildcard',
    'SAFT48kHz8BitStereo', 'SAFT16kHz16BitMono',
    'SDA_Two_Trailing_Spaces', 'SVP_18', 'DISPID_SVSLastBookmark',
    'SVSFParseSsml', 'SREInterference', 'DISPID_SpeechMemoryStream',
    'SpeechAudioVolume', 'DISPID_SRGCommit', 'SpeechBookmarkOptions',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SDKEnumKeys',
    'DISPID_SREmulateRecognition', 'SPSSuppressWord', 'DISPID_SVSkip',
    'DISPID_SpeechPhraseRules', 'eLEXTYPE_PRIVATE12',
    'DISPID_SRRTimes', 'DISPID_SPIAudioSizeTime',
    'DISPID_SpeechPhraseProperties', 'SAFTGSM610_22kHzMono',
    'DISPID_SpeechMMSysAudio', 'SP_VISEME_8', 'SpPhraseInfoBuilder',
    'SPBO_AHEAD', 'DISPID_SRCERecognitionForOtherContext',
    'SpeechVisemeFeature', 'SSSPTRelativeToStart', 'SRADynamic',
    'SAFT11kHz8BitStereo', 'SECFIgnoreKanaType',
    'SpeechCategoryAppLexicons', 'SPEI_RESERVED5', 'SPVPRI_OVER',
    'DISPID_SpeechBaseStream', 'DISPID_SPEActualConfidence',
    'SDTReplacement', 'SRTStandard', 'SRSActiveAlways',
    'SpPhoneConverter', 'ISpPhraseAlt', 'DISPID_SpeechPhoneConverter',
    'SVF_Emphasis', 'eLEXTYPE_PRIVATE19',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SBSWrite',
    'DISPID_SGRsDynamic', 'SVSFNLPSpeakPunc',
    'DISPID_SDKSetLongValue', 'SAFT11kHz16BitStereo',
    'ISpRecoContext', 'SPXRO_SML', 'DISPID_SRCEBookmark',
    'DISPID_SMSALineId', 'SINone', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SVGetVoices', 'DISPID_SGRSTPropertyId', 'DISPID_SAStatus',
    'SpeechSpecialTransitionType', 'DISPID_SRCEFalseRecognition',
    'DISPID_SRGState', 'DISPID_SGRSAddRuleTransition',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SPPValue',
    'SPEI_START_SR_STREAM', 'eLEXTYPE_PRIVATE9', 'SPSMF_UPS',
    'SPFILEMODE', 'SINoSignal', 'SDKLLocalMachine', 'SPEI_MIN_TTS',
    'SVP_4', 'DISPID_SRSClsidEngine', 'SPRULE', 'SPPS_RESERVED1',
    'SPPS_RESERVED3', 'DISPID_SVGetAudioInputs',
    '_ISpeechRecoContextEvents', 'SPGS_DISABLED',
    'SAFT12kHz16BitMono', 'SPRS_ACTIVE', 'SPEI_HYPOTHESIS',
    'SPCT_DICTATION', 'ISpeechPhraseProperties', 'SPLEXICONTYPE',
    'SAFTGSM610_8kHzMono', 'SPINTERFERENCE_TOOQUIET', 'SP_VISEME_11',
    'DISPID_SWFEExtraData', 'SRARoot', 'SPFM_OPEN_READONLY',
    'DISPID_SGRsItem', 'SPSInterjection', 'SAFTCCITT_ALaw_44kHzMono',
    'SPAR_Low', 'ISpNotifySource', 'DISPID_SRCRetainedAudioFormat',
    'SpMMAudioEnum', 'SpeechVisemeType', 'SBONone', 'SVSFDefault',
    'DISPID_SPIEngineId', 'DISPID_SOTCreateInstance', 'SpFileStream',
    'eLEXTYPE_PRIVATE17', 'SPPS_Noun', 'SpeechTokenKeyUI',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SRRTLength',
    'DISPID_SPIProperties', 'DISPID_SpeechPhraseElements',
    'SDA_No_Trailing_Space', 'SAFTADPCM_11kHzMono', 'SGLexical',
    'SPDATAKEYLOCATION', 'SPWT_LEXICAL', 'SpCompressedLexicon',
    'DISPID_SPEAudioSizeTime', 'ISpObjectTokenCategory',
    'SVF_Stressed', 'DISPID_SVEEnginePrivate', 'SAFT24kHz16BitStereo',
    'DISPID_SVEBookmark', 'SpeechPropertyResourceUsage',
    'ISpXMLRecoResult', 'DISPID_SPPParent', 'SVP_1', 'SREPrivate',
    'DISPID_SRCRecognizer', 'ISpeechWaveFormatEx',
    'DISPID_SVSVisemeId', 'SPPS_NotOverriden',
    'SpeechCategoryRecognizers', 'DISPID_SPARecoResult',
    'SpeechEngineProperties', 'DISPID_SPEsCount', 'SVP_0',
    'SpeechInterference', 'SPXMLRESULTOPTIONS',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'ISpDataKey', 'DISPID_SGRsCount',
    'SPPHRASEELEMENT', 'SGLexicalNoSpecialChars', 'DISPID_SGRSTText',
    'DISPID_SPIGetText', 'ISpeechObjectTokenCategory',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SMSSetData',
    'SDKLDefaultLocation', 'SpLexicon', 'SpAudioFormat',
    'SAFTCCITT_ALaw_22kHzMono',
    'SpeechPropertyNormalConfidenceThreshold', 'IEnumSpObjectTokens',
    'SVP_14', 'SpeechAllElements', 'DISPID_SLWsCount',
    '_RemotableHandle', 'DISPID_SASFreeBufferSpace',
    'ISpObjectWithToken', 'SPEI_TTS_BOOKMARK',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SVIsUISupported',
    'SINoise', 'ISpeechRecoGrammar', 'DISPID_SGRAddState',
    'SPEI_RESERVED6', 'ISpStream', 'DISPID_SGRSTRule',
    'ISpeechPhraseReplacements', 'DISPID_SpeechLexiconProns',
    'DISPID_SpeechLexiconPronunciation', 'SPINTERFERENCE_TOOSLOW',
    'ISpeechGrammarRuleStateTransitions', 'STCRemoteServer',
    'DISPID_SPIStartTime', 'DISPID_SLWsItem', 'SECLowConfidence',
    'SRSInactiveWithPurge', 'SPPHRASERULE', 'SSSPTRelativeToEnd',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPDKL_CurrentConfig',
    'ISpeechLexicon', 'DISPID_SOTCId', 'DISPID_SVAudioOutput',
    'DISPID_SVSInputSentencePosition',
    'DISPID_SPANumberOfElementsInResult', 'SRTExtendableParse',
    'SPSERIALIZEDPHRASE', 'STSF_FlagCreate',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SWFEChannels',
    'SGDSActiveUserDelimited', 'SPEVENT', 'SDTAll', 'SPRST_ACTIVE',
    'DISPID_SRCEAdaptation', 'DISPID_SRGIsPronounceable',
    'eLEXTYPE_PRIVATE16', 'DISPID_SPPFirstElement',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SRRecognizer',
    'SVSFParseSapi', 'SVSFIsXML', 'DISPID_SpeechObjectTokens',
    'SVP_17', 'SPEI_RESERVED3', 'DISPID_SLWPronunciations', 'SVP_8',
    'SDTLexicalForm', 'DISPID_SOTGetDescription',
    'SpeechWordPronounceable', 'DISPID_SMSGetData',
    'DISPID_SRSNumberOfActiveRules', 'STCAll', 'SWTAdded',
    'SPAR_Unknown', 'SECFDefault', 'DISPID_SpeechVoiceStatus',
    'DISPID_SBSRead', 'DISPID_SVEStreamStart', 'SPEI_RESERVED1',
    'SVEEndInputStream', 'DISPID_SVEViseme',
    'ISpeechTextSelectionInformation',
    'DISPID_SASCurrentSeekPosition', 'ISpEventSink',
    'SAFT22kHz8BitMono', 'SVP_19', 'DISPID_SpeechCustomStream',
    'ISpeechObjectTokens', 'DISPID_SPAs_NewEnum',
    'SWPUnknownWordUnpronounceable', 'IInternetSecurityManager',
    'SGSEnabled', 'DISPID_SRRGetXMLErrorInfo', 'eLEXTYPE_PRIVATE14',
    'DISPID_SGRSRule', 'DISPID_SGRSTWeight', 'SPEI_MAX_SR',
    'SGRSTTRule', 'SSTTDictation', 'SPRS_ACTIVE_USER_DELIMITED',
    'SPWAVEFORMATTYPE', 'eLEXTYPE_PRIVATE11', 'ISpShortcut',
    'SpeechGrammarTagUnlimitedDictation', 'ISpPhrase',
    'DISPID_SRCRetainedAudio', 'SpeechWordType', 'SGRSTTTextBuffer',
    'SpeechAudioFormatGUIDText',
    'SpeechGrammarRuleStateTransitionType', 'SpInprocRecognizer',
    'DISPID_SDKSetBinaryValue', 'ISpeechAudioBufferInfo',
    'SAFTADPCM_44kHzMono', 'SVESentenceBoundary', 'DISPID_SVSpeak',
    'DISPID_SLGetGenerationChange', 'DISPID_SRGId', 'SPAUDIOOPTIONS',
    'SpeechEmulationCompareFlags', 'SVP_3', 'DISPID_SRRPhraseInfo',
    'SPEVENTSOURCEINFO', 'DISPID_SRCESoundStart', 'SRCS_Enabled',
    'DISPID_SVVoice', 'SECFEmulateResult',
    'DISPID_SLGetPronunciations', 'SPCT_SUB_DICTATION',
    'DISPID_SPIEnginePrivateData', 'DISPID_SpeechLexicon',
    'DISPID_SOTIsUISupported', 'SPINTERFERENCE_NONE',
    'SPEI_END_SR_STREAM', 'SpeechAddRemoveWord',
    'DISPID_SGRSAddSpecialTransition', 'SAFTCCITT_uLaw_8kHzMono',
    'SpWaveFormatEx', 'DISPID_SABIEventBias',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SGRClear',
    'ISpeechRecoResult2', 'SPEI_RESERVED2', 'DISPID_SFSClose',
    'SPPHRASE', 'SpeechRecognitionType', 'DISPID_SVRate',
    'DISPID_SRAudioInputStream', 'ISpRecognizer2',
    'SpStreamFormatConverter', 'WAVEFORMATEX', 'SRCS_Disabled',
    'SDTRule', 'SPCT_SLEEP', 'SPVISEMES', 'SPSHT_OTHER', 'SpShortcut',
    'DISPID_SAVolume', 'SP_VISEME_21', 'SRADefaultToActive',
    'DISPID_SRGetPropertyString', 'SpeechFormatType',
    'DISPID_SPRuleChildren', 'ISpeechGrammarRule',
    'DISPID_SPAPhraseInfo', 'SpeechRecoProfileProperties', 'SRSEDone',
    'SAFTADPCM_11kHzStereo', 'SpeechCategoryRecoProfiles',
    'SPSMF_SAPI_PROPERTIES', 'ISpRecoGrammar',
    'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SAFT12kHz16BitStereo', 'SAFTNoAssignedFormat',
    'DISPID_SpeechPhraseProperty', 'DISPID_SLAddPronunciation',
    'SVP_12', 'SPSVerb', 'DISPID_SRSCurrentStreamPosition', 'SASRun',
    'DISPID_SLAddPronunciationByPhoneIds', 'ISpObjectToken',
    'DISPID_SPEPronunciation', 'DISPID_SPPs_NewEnum',
    'SPDKL_CurrentUser', 'SPPS_Interjection', 'ISpRecognizer3',
    'eLEXTYPE_PRIVATE3', 'SDTAudio', 'ISpVoice',
    'SPINTERFERENCE_NOISE', 'DISPID_SpeechRecognizer',
    'DISPID_SpeechGrammarRule', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SPCPhoneToId', 'DISPID_SRCCreateGrammar',
    'DISPID_SPEAudioSizeBytes',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SpNullPhoneConverter',
    'ISpeechPhraseReplacement', 'DISPID_SRGCmdLoadFromResource',
    'eLEXTYPE_RESERVED7', 'SP_VISEME_0', 'SPEI_REQUEST_UI',
    'SSTTWildcard', 'SpeechTokenKeyFiles', 'SAFT11kHz8BitMono',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SpeechDataKey', 'SSTTTextBuffer', 'eLEXTYPE_PRIVATE4',
    'DISPID_SOTs_NewEnum', 'SPSFunction',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SDKGetStringValue',
    'SDTAlternates', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SPCIdToPhone', 'eWORDTYPE_DELETED',
    'DISPID_SPELexicalForm', 'DISPID_SLWLangId', 'ISpRecoResult',
    'SPEI_SOUND_START', 'DISPID_SRCEHypothesis', 'SPRECORESULTTIMES',
    'DISPID_SLPPartOfSpeech', 'DISPID_SPRuleName', 'DISPID_SGRId',
    'eLEXTYPE_RESERVED9', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SVEVoiceChange', 'SPBO_NONE', 'SpeechLexiconType',
    'SPEI_VOICE_CHANGE', 'DISPID_SDKSetStringValue', 'SPVPRIORITY',
    'DISPID_SRRAudio', 'SREHypothesis', 'DISPID_SPRNumberOfElements',
    'SPCATEGORYTYPE', 'SpeechCategoryAudioOut',
    'DISPID_SpeechLexiconWord', 'SREStreamStart', 'DISPID_SFSOpen',
    'DISPID_SPRuleNumberOfElements', 'SPEI_SR_BOOKMARK',
    'SAFTGSM610_44kHzMono', 'SPPROPERTYINFO', 'SPCS_DISABLED',
    'SRESoundStart', 'SVEAudioLevel', 'SPEI_START_INPUT_STREAM',
    'DISPID_SPAsItem', 'SAFT48kHz16BitStereo', 'SECFIgnoreWidth',
    'SVP_11', 'DISPID_SLWs_NewEnum', 'SAFTCCITT_ALaw_44kHzStereo',
    'SPPS_SuppressWord', 'DISPIDSPTSI_ActiveLength', 'SPLO_DYNAMIC',
    'SPSHORTCUTTYPE', 'SGPronounciation', 'DISPID_SPIAudioSizeBytes',
    'SREBookmark', 'ISpeechCustomStream', 'DISPID_SRDisplayUI',
    'SpeechCategoryPhoneConverters', 'DISPID_SRSSupportedLanguages',
    'SPRST_INACTIVE_WITH_PURGE', 'SAFT44kHz16BitStereo',
    'DISPID_SVAudioOutputStream', 'SpSharedRecoContext',
    'SAFT24kHz8BitMono', 'DISPID_SRRAudioFormat',
    'DISPID_SOTCGetDataKey', 'SPINTERFERENCE_LATENCY_WARNING',
    'SLOStatic', 'SVSFIsNotXML', 'DISPID_SOTSetId',
    'eLEXTYPE_PRIVATE20', 'ISpeechRecoResult',
    'DISPID_SPEEngineConfidence', 'DISPID_SDKEnumValues',
    'SRERecoOtherContext', 'SAFTText', 'DISPID_SRIsShared',
    'SITooFast', 'SVSFlagsAsync', 'ISpeechDataKey',
    'SPPHRASEREPLACEMENT', 'SVEPhoneme', 'SVEBookmark',
    'DISPID_SPRText', 'DISPID_SLRemovePronunciation', 'SAFTDefault',
    'SAFT24kHz8BitStereo', 'DISPID_SGRSTransitions',
    'ISpRecoGrammar2', 'DISPID_SpeechPhraseBuilder',
    'SPEI_SR_PRIVATE', 'STCLocalServer', 'DISPID_SPPConfidence',
    'SAFTADPCM_22kHzStereo', 'DISPID_SVEPhoneme', 'DISPID_SVPriority',
    'SPRULESTATE', 'ISpPhoneticAlphabetConverter', 'SPEI_VISEME',
    'SPFM_CREATE', 'LONG_PTR', 'DISPID_SOTCategory', 'SVP_10',
    'DISPID_SRRAlternates', 'SPSEMANTICERRORINFO',
    'ISpeechBaseStream', 'DISPID_SPCLangId',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SRGCmdLoadFromObject', 'SpeechDictationTopicSpelling',
    'SAFT8kHz16BitStereo', 'eLEXTYPE_RESERVED6',
    'DISPID_SPEAudioStreamOffset', 'SAFT8kHz16BitMono',
    'DISPID_SLPPhoneIds', 'DISPID_SGRsCommitAndSave',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SRRTStreamTime',
    'DISPID_SAFGuid', 'SAFTCCITT_uLaw_22kHzMono', 'SpeechDiscardType',
    'SRTAutopause', 'ISpeechPhraseProperty', 'SVEAllEvents',
    'SREPropertyNumChange', 'SRSEIsSpeaking', 'DISPID_SpeechAudio',
    'SRTSMLTimeout', 'SP_VISEME_20', 'SpObjectToken',
    'DISPID_SLPType', 'DISPID_SVEWord', 'SPCONTEXTSTATE',
    'SAFT16kHz8BitStereo', 'SpeechLoadOption',
    'DISPID_SOTGetAttribute', 'SP_VISEME_13',
    'ISpPhoneticAlphabetSelection', 'ISpeechVoice',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SpeechRecoResult',
    'SPEI_PHONEME', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SGRSTTWildcard', 'SPSHT_EMAIL', 'DISPIDSPTSI_SelectionLength',
    'ISpRecognizer', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'ISpeechMMSysAudio', 'DISPID_SRRSetTextFeedback',
    'DISPID_SRGDictationSetState', 'DISPID_SPISaveToMemory',
    'DISPID_SPPNumberOfElements', 'DISPID_SWFEBitsPerSample',
    'SpeechTokenKeyAttributes', 'SGDisplay', 'SPTEXTSELECTIONINFO',
    'SPAS_RUN', 'SPXRO_Alternates_SML', 'SPRST_ACTIVE_ALWAYS',
    'SpeechDisplayAttributes', 'SPGS_EXCLUSIVE',
    'SAFTGSM610_11kHzMono', 'DISPID_SPILanguageId',
    'DISPID_SGRAttributes', 'SLTUser', 'tagSPPROPERTYINFO',
    'SpeechTokenIdUserLexicon', 'DISPID_SASNonBlockingIO',
    'SSFMCreateForWrite', 'Speech_Max_Word_Length',
    'DISPID_SPIRetainedSizeBytes', 'ISpNotifyTranslator',
    'DISPID_SPRs_NewEnum', 'SPWORDTYPE', 'SPWF_INPUT',
    'DISPID_SpeechAudioStatus', 'DISPID_SAFSetWaveFormatEx',
    'eWORDTYPE_ADDED', 'DISPID_SVStatus', 'DISPID_SVWaitUntilDone',
    'DISPID_SOTGetStorageFileName', 'DISPID_SAFType',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SPPChildren', 'SVPNormal',
    'DISPID_SRSAudioStatus', 'SP_VISEME_9', 'SPBO_TIME_UNITS',
    'DISPID_SRGetFormat', 'DISPID_SRCEEndStream', 'DISPID_SRCPause',
    'DISPID_SpeechAudioFormat', 'DISPID_SRGReset',
    'DISPID_SRCEEnginePrivate', 'SPSHT_Unknown',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPPS_Verb', 'SVP_21',
    'SPVOICESTATUS', 'SVP_5'
]
